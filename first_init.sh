...
echo "Extract image"
cat $(find "$DIR/images/" -name "django_2.2.1.tar.gz*") > "$DIR/images/django_2.2.1.tar.gz" 
gzip -d "$DIR/images/django_2.2.1.tar.gz"
rm "$DIR/images/django_2.2.1.tar.gz" 
...
echo "Load image"
"$DIR/scripts/docker_load_image.sh" "$DIR/images/django_2.2.1.tar"
